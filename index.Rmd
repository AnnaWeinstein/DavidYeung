...
![](images/EMP cover_art_grayscale.jpg)
...
In order to try to make the material accessible to all those in the DID community, both diagnosed individuals and their support network, all the blog posts have been compiled into this single volume. The Table of Contents lists all of the posts, which have been grouped in different categories. This Volume 4 is downloadable for free as an ebook or pdf at ????????. It is available in print through Amazon at cost.
